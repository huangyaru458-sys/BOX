  ...
  <view class="template-ucharts tn-safe-area-inset-bottom">
    ...
    <view class="" :style="{paddingTop: vuex_custom_bar_height + 10 +  'px'}">
      ...
      <view class="tn-padding-top-xl tn-padding-bottom-xl">
        ...
        <view class="" style="min-height: 500rpx;">
          <qiun-data-charts canvas2d type="pie" :opts="categoryOpts" :chartData="categoryChartData" />
        </view>
      </view>
    ...
    methods: {
      ...
      drawCategoryCharts() {
        let res = {
          series: [
            {
              data: [{"name":"T恤","value":7800},{"name":"外套","value":6600},{"name":"衬衫","value":4200},{"name":"上衣","value":5200},{"name":"长裤","value":3000}]
            }
          ]
        };
        this.categoryChartData = JSON.parse(JSON.stringify(res));
      },
